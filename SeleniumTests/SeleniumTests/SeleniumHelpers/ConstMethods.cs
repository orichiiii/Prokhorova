...
namespace SeleniumTests
{
    public class ConstMethods
    {
        ...
        public void RegistrationProcess(string phone, string email, string password)
        {
            ...
            _webDriver.FindElement(By.CssSelector("[name = password]")).SendKeys(password);
            _webDriver.FindElement(By.CssSelector("[name = password_confirm]")).SendKeys(password);
